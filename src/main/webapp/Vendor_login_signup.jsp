...
<body>
	...
	<div class="instructions">
        <h3>How to Create an Account & List Products</h3>
        <ol>
            <li>Click "Sign up here" to start the signup process.</li>
            <li>Fill in your personal and company information accurately.</li>
            <li>Upload your Trade License and Government ID for verification.</li>
            <li>Submit the form and wait for admin approval.</li>
            <li>Once approved, log in to your account.</li>
            <li>Go to the "Product Listing" section in the vendor dashboard.</li>
            <li>Fill in product details like name, price, description, and upload images.</li>
            <li>Submit the product listing for admin review.</li>
            <li>After approval, your product will be listed on the site.</li>
        </ol>
    </div>
    ...
    <div class="container">
        <div class="form-wrapper login-active" id="formWrapper">
            <div class="form-container login-form">
                ...
                <%}%>
                <form action="VendorLoginHandler" method="POST">
                    <label for="username">Username</label>
                    <input type="text" id="username" name="vendor-login-username" placeholder="Enter your username" required>
                    
                    <label for="password">Password</label>
                    <input type="password" id="password" name="vendor-login-password" placeholder="Enter your password" required>
            ...
            <div id="forgetPasswordPopup" class="forget-pass-popup-overlay">
    			<div class="forget-pass-popup-content">
        			...
        			<form action="VendorOperationsHandler?operation=vendor-password-otp" method="post" id="forget-password-form" class="active">
            		<div class="security-code-input">
                		<input type="text" name="vendor-email-phone" placeholder="Enter Email or Phone Number" required>
            		</div>
            ...
            <div class="form-container signup-form">
                ...
                <%}%>
                <form action="VendorSignupHandler" method="POST" enctype="multipart/form-data">
                    <label for="firstname">First Name</label>
                    <input type="text" id="firstname" name="vendor-firstname" placeholder="Enter your first name" required>
                    
                    <label for="lastname">Last Name</label>
                    <input type="text" id="lastname" name="vendor-lastname" placeholder="Enter your last name" required>

                    <label for="email">Email</label>
                    <input type="email" id="email" name="vendor-email" placeholder="Enter your email" required>
                    
                    <label for="phone">Phone</label>
                    <input type="text" id="phone" name="vendor-phone" placeholder="Enter your number" required>                    
                    
                    <label for="username">Username</label>
                    <input type="text" id="username" name="vendor-username" placeholder="Enter your username" required>
                    
                    <div class="form-row">
                        <div class="form-group">
                            <label for="password-signup">Password</label>
                            <input type="password" id="password-signup" name="vendor-password" placeholder="Create a password" required>
                        </div>
                        <div class="form-group">
                            <label for="confirmpassword">Confirm Password</label>
                            <input type="password" id="confirmpassword" name="vendor-confirmpassword" placeholder="Confirm your password" required>
                        </div>
                    </div>
					<h2>Personal Address</h2>
                    <label for="address">Address</label>
                    <input type="text" id="address" name="vendor-address" placeholder="Enter your address" required>

                    <div class="form-row">
                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="text" id="city" name="vendor-city" placeholder="Enter your city" required>
                        </div>
                        <div class="form-group">
                            <label for="state">State</label>
                            <input type="text" id="state" name="vendor-state" placeholder="Enter your state" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="zip" name="vendor-zip" placeholder="Enter your zip code" required>
                        </div>
                    </div>
                    <h2>Company/Shop Address</h2>
                    <label for="brand-name">Shop Name/Number</label>
                    <input type="text" id="brand-name" name="vendor-shop-name" placeholder="Enter your brand/shop name" required>
                    
                    <label for="address">Address</label>
                    <input type="text" id="address" name="shop-address" placeholder="Enter your address" required>

                    <div class="form-row">
                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="text" id="city" name="shop-city" placeholder="Enter your city" required>
                        </div>
                        <div class="form-group">
                            <label for="state">State</label>
                            <input type="text" id="state" name="shop-state" placeholder="Enter your state" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="zip">Zip Code</label>
                            <input type="text" id="zip" name="shop-zip" placeholder="Enter your zip code" required>
                        </div>
                    </div>
					
					<h2>Business Compliance Documents.</h2>
                    <div class="upload-section">                    	
                    	<label for="gstn">GST Number</label>
                    	<input type="text" id="gstn" name="vendor-gstn" placeholder="Enter your GSTN" required>
                    	
                        <label for="profile-pic">Trade License</label>
                        <input type="file" id="trade-license" name="vendor-trade-license" required>

                        <label for="govt-id">Government ID</label>
                        <input type="file" id="govt-id" name="vendor-gov-id" required>
                    </div>
...
<form action="VendorSignupHandler?type=otp" method="post" id="code-submit">
