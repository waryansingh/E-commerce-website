...
<div class="navbar">
    ...
    <form action="VendorOperationsHandler" method="get">
        <input type="text" placeholder="Search products..." name="product-type">
        <input type="hidden" value="srearch-result" name="request-type">
...
<div class="container">
    <div class="product-card">
        ...
        <div class="product-info">
            ...
            <p>Stock status: <%=((AllProducts.Clothing)product).get_data("product_stock_status").equals("1")?"In Stock":"Out Of Stock"%></p>
        ...
        <form action="VendorOperationsHandler" method="get">
            ...
            <input type="hidden" value=<%=((AllProducts.Clothing)product).get_data("product_id")%> name="product-id">
            <input type="hidden" value=<%=((AllProducts.Clothing)product).get_data("product_type")%> name="product-type">
            <select name="product-stock-status">
            ...
            <form action="VendorOperationsHandler" method="get">
            <input type="hidden" value="edit_product" name="request-type">
            <input type="hidden" value=<%=((AllProducts.Clothing)product).get_data("product_id")%> name="product-id">
            <input type="hidden" value=<%=((AllProducts.Clothing)product).get_data("product_type")%> name="product-type">
...
<div class="container">
    <div class="product-card">
        ...
        <div class="product-info">
            ...
            <p>Stock status: <%=((AllProducts.Electronics)product).get_data("product_stock_status").equals("1")?"In Stock":"Out Of Stock"%></p>
        ...
        <form action="VendorOperationsHandler" method="get">
        	<input type="hidden" value="alter_product_stock_status" name="request-type">
            <input type="hidden" value=<%=((AllProducts.Electronics)product).get_data("product_id")%> name="product-id">
            ...
            <form action="VendorOperationsHandler?request-type=edit_product" method="get">
            <input type="hidden" value="edit_product" name="request-type">
            <input type="hidden" value=<%=((AllProducts.Electronics)product).get_data("product_id")%> name="product-id">
            <input type="hidden" value=<%=((AllProducts.Electronics)product).get_data("product_type")%> name="product-type">
            	<button type="submit">Edit</button>
...
<div class="container">
    <div class="product-card">
        ...
        <div class="product-info">
            ...
            <p>Stock status: <%=((AllProducts.Food)product).get_data("product_stock_status").equals("1")?"In Stock":"Out Of Stock"%></p>
        ...
        <form action="VendorOperationsHandler" method="get">
        	<input type="hidden" value="alter_product_stock_status" name="request-type">
            <input type="hidden" value=<%=((AllProducts.Food)product).get_data("product_id")%> name="product-id">
